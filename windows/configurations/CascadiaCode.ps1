...
try {
	...
	if ($fontFamilies -notcontains "Cascadia Code NF") {
		Write-Host "Cascadia Code fonts installation..." -ForegroundColor "Yellow"
...
"
		...
		Write-Host "✔️ Cascadia Code fonts installation is complete." -ForegroundColor "Green"
	}
	else {
		Write-Host "✔️ Cascadia Code fonts are already installed." -ForegroundColor "Green"
	}
}
catch {
